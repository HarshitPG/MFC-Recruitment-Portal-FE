    ...
    <div className="w-full h-full flex flex-col md:flex-row justify-center items-center p-4 md:p-12">
      ...
      <BoundingBox>
        <div className="w-full h-full text-center relative">
          ...
          <div className="nes-container is-rounded is-dark text-[0.6rem] md:text-base text-left md:text-center">
            <p>
          ...
          <section className="icon-list flex gap-8 mt-8 w-full justify-center scale-75 md:scale-100">
